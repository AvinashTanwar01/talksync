...
//         </button>
//         <div tabIndex={0} className='dropdown-content mt-2 p-1 shadow-2xl bg-base-200 backdrop-blur-lg rounded-2xl w-5/6 border border-base-content/10 max-h-80 overflow-y-auto'>
//         <div className='space-y-1'>
//             {THEMES.map((themeOption)=>(
//                 <button key={themeOption.name}
//                 className={`w-full px-4 py-3 rounded-xl flex items-center transition-colors ${
//                     theme=== themeOption.name ?
//                     "bg-primary/10 text-primar":
